...
- Have two views: a landing view and a game view
...
- Include a screenshot of the landing page and a screenshot of the game play page.
...
> ***Note*** If you're creating a two (or more)-player game, you MUST:
>
...
- Include animation using HTML Canvas or SVG
...
- A written proposal, **printed out** including:
...
- A readme.md file with:
	- A link to your live game deployed on [GitHub Pages](https://pages.github.com/)
...
- A presentation deck - Google Slides, Keynote, PowerPoint - of at least 3 slides that answer the questions above and images of your wireframes and a screenshot of your landing page.
